...
$baseAuthor = $BRAND;
$URL  = "https://dkppp.depok.go.id/assets/fant/?brookyln=$BRAND";
$PAGEURL = "https://dkppp.depok.go.id/assets/fant/?brookyln=$BRAND";
$AMP = "https://tanjung.pages.dev/assets/fant/?brookyln=$BRAND";
$DAFTAR = "https://tanjung.pages.dev/assets/fant/";
$BANNER = "https://iili.io/3z5fcyN.jpg";
$LOGO = "https://studiointermedia.com/images/2025/03/11/logo-new.png";
$keyword = "$brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND 🔱 Platform Penambah Penghasilan";
    $DESCRIPTION = "$BRAND sebuah platform yang bisa menambah penghasilan hanya dengan menggunakan handphone anda sudah dapat menambah penghasilan anda, dan jika berhasil bisa menaklukan setiap season automatis anda akan mendapatkan kemenangan yang besar.";
    $description = "$BRAND sebuah platform yang bisa menambah penghasilan hanya dengan menggunakan handphone anda sudah dapat menambah penghasilan anda, dan jika berhasil bisa menaklukan setiap season automatis anda akan mendapatkan kemenangan yang besar.";
}
...
<!doctype html>
  ...
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="https://fotoku.host/download.png" />
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $URL ?>" data-animation-role="header-element">
                      ...
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://studiointermedia.com/images/2025/03/11/logo-new.png"
